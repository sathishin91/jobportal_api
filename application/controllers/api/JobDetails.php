            ...
            if ($this->ApiCommonModel->checkApiKey($api_key)) {
                ...
                if (!empty($reqData['user_id'])) {
                    ...
                    if ($this->form_validation->run() == TRUE) {
                        ...
                        $val = 'job_details.id,job_details.user_id,job_details.address_no,job_details.company_name,job_details.job_type,job_details.night_shift,job_details.paytype,job_details.min_salary, job_details.max_salary,job_details.incentive,job_details.is_active,job_details.is_verify,job_details.is_completed,job_details.create_date,
                        job_details.update_date,
                        
                        job_location.address_no, job_location.location_type, job_location.location_type_name, job_location.wh_city, job_location.wh_address, job_location.wh_address2, job_location.wo_place,job_location.wo_city,job_location.fj_area,
